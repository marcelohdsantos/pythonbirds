...
3) método frear que deverá decrementar em duas unidades

A Direção terá a responsabilidade de controlar a direção. Ela oferece os seguintes atributos:
1) valor da direção com: Norte, sul, leste e Oeste
...
class Motor:
    ...
    def frear(self):
        self.velocidade -= 2
        self.velocidade = max(0, self.velocidade)  # função max() retorna 0 se o valor self.velocidade for negativo
